    ...
    async def test_parse_sample_csv_data(
        ...
        with aioresponses() as m:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                assert all(event.datetime_start is not None for event in events)
...
Another,incomplete"""
    ...
    def test_parse_csv_row_valid_food_truck(
        ...
        assert result.datetime_start.year == 2025
        assert result.datetime_start.month == 8
        assert result.datetime_start.day == 1
...
Tue,Feb 20,12 AM,to,Tue,Food Truck,February Truck,Sun,Tue,FALSE,TRUE"""
        ...
        with aioresponses() as m:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                for event in events:
                    assert event.datetime_start.year == 2026
