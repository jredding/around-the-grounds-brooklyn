"""Tests for shared HTTP request defaults used by scraper and analyzer."""
...
def test_scraper_coordinator_scrape_all_uses_default_headers() -> None:
    """scrape_all() should also inherit shared browser-like headers."""
    captured = {}
    ...
    with patch(
        ...
        asyncio.run(coordinator.scrape_all([venue]))
